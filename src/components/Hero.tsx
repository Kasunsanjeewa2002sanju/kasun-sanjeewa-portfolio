...
const Hero = () => {
  ...
  return <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="geometric-shape geometric-orange w-16 h-16 top-1/2 left-8 transform -rotate-45 animate-float" style={{
        animationDelay: '1s'
      }} />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="flex flex-wrap gap-4">
              <a href="mailto:kasunsanjeewa2002@gmail.com" className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors">
                <Mail className="h-4 w-4" />
                <span>kasunsanjeewa2002@gmail.com</span>
              </a>
              <a href="tel:+94778063196" className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors">
          ...
          <div className="flex justify-center lg:justify-end animate-slide-in-right">
            <div className="relative">
              <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden border-4 border-primary/20 shadow-2xl">
                <img src={kasunProfile} alt="Kasun Sanjeewa Senavirathna" className="w-full h-full object-cover" />
              </div>
              {/* Floating badge */}
